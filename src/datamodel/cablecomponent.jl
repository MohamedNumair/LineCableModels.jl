...
mutable struct CableComponent{T<:REALSCALAR}
    ...
    function CableComponent{T}(
        ...
        conductor_props = Material{T}(ρ_con, T(0), μ_con, θ_con, α_con, mat_con.rho_thermal, mat_con.theta_max, mat_con.tan_delta, mat_con.sigma_solar)
        ...
        insulator_props = Material{T}(ρ_ins, ε_ins, μ_ins_corr, θ_ins, T(0), mat_ins.rho_thermal, mat_ins.theta_max, mat_ins.tan_delta, mat_ins.sigma_solar)
