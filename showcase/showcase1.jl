...
TwoColumn(
	...
	- #### Cables as a part of multi-GW future power grids.
		...
		""",
	md"""$(LocalResource(joinpath(@__DIR__, "..", "assets", "img", "cables1.png"), :width => 250, :style => "display: block; margin-left: auto; margin-right: auto; margin-bottom: 50px;"))
   $(LocalResource(joinpath(@__DIR__, "..", "assets", "img", "cables2.png"), :width => 250, :style => "display: block; margin-left: auto; margin-right: auto;"))
   	""")
