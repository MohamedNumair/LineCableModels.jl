...
@testset "BaseParams module" begin
	...
	@testset "GMD and equivalent GMR" begin
		...
		part3_wirearray = WireArray(0.03, 0.002, 7, 10, aluminum_props) # Wire array, separate
		...
		layer3_wa = WireArray(layer2.radius_ext, 0.001, 12, 15, copper_props)
	...
	@testset "Basic uncertainty propagation" begin
		...
		R_m = calc_tubular_resistance(r_in_m, r_ext_m, rho_m, 0, 20.0, 20.0)
